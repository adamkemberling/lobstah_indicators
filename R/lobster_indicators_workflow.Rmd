...
## Export Predator Indicators

```{r}

# Pull out important columns
predator_indices <- select(predator_summs,
                           year = est_year,
                           season = season,
                           `stratum id` = lobster_strata,
                           `mean length (cm)`,
                           `mean weight (kg)`,
                           `stratum abundance`,
                           `stratum biomass (kg)`,
                           ...
                           `stratified biomass (kg)`)

# Export
write_rds(predator_indices, here::here("data/nmfs_trawl_lobster_predator_indices.rdata"))
```
